                               ...
                               <div class="card-body">
                                   ...
                                   <div class="post">
                                       <div class="user-block">
                                           ...
                                           <span class="description"><?= $dataselected['created_date']?></span>
                                       </div>
                                       <!-- /.user-block -->
                                       <h2><?= $dataselected['judul_pengaduan'] ?></h2>
                                       <p>
                           ...
                           <form action="<?= base_url('admin/actverifadmin') ?>" method="POST">
                               ...
                               <div class="modal-body">
                                   <div class="form-group">
                                       ...
                                       <input type="hidden" name="id_pengaduan" value="<?= $dataselected['id_pengaduan'] ?>">
