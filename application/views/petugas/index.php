                       ...
                       <div class="col-12">
                           <div class="card">
                               <div class="card-header">
                                   <h3 class="card-title">Data List Dari Semua Laporan Masyarakat</h3>
                               </div>
                               <!-- /.card-header -->
                               <div class="card-body">
                                       ...
                                       <tbody>
                                           ...
                                           <?php foreach ($array as $sm) : ?>
                                               <tr>
                                                   ...
                                                   <td><div class="row">
                                                           <div class="col-sm-12">
                                                               <button type="button" class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#modal-default">Hapus Laporan</button>
                       ...
                       <div class="modal-content">
                           <div class="modal-body">
                               <div class="form-group">
                                   <h5>Apakah anda yakin ingin menghapus pengaduan ini?</h5>
                               </div>
                           </div>
                           <div class="modal-footer justify-content-between">
                               <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                               <a href="<?= base_url('admin/deletePengaduanAdmin2/' . $sm['id_pengaduan']) ?>">
